...
<!--four-grids here-->
		<div class="four-grids">
					<div class="col-md-3 four-grid link" onClick='navigate("manage-users")'>
...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid link" onClick='navigate("manage-bookings")'>
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid link" onClick='navigate("manage-enquires")'>
						<div class="four-w3ls">
							<div class="icon">
						...
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3>Total packages</h3>
																	<?php $sql3 = "SELECT PackageId from tblgympackages";
...
$cnt3=$query3->rowCount();
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid link"  onClick='navigate("manageissues")' >
						<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
