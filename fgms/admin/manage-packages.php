				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Packages</h2>
						...
						<tbody>
<?php $sql = "SELECT * from TblGymPackages";
...
{				?>		
						  <tr>
							...
							<td>
								...
								<a href="delete-package.php?pid=<?php echo htmlentities($result->PackageId); ?>"><button type="button" class="btn btn-danger m-5 btn-block">Delete</button></a>
